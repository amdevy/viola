          ...
          <div className='grid grid-cols-1 lg:grid-cols-2 gap-12 items-center'>
            ...
            <div>
              ...
              <p className='text-[#1A1A1A]/70 text-lg leading-relaxed mb-8'>
                <a href="https://www.nagolovy.pro/" target="_blank" rel="noopener noreferrer" className="text-[#C4A882] hover:underline">Na Golov[y]</a> — український бренд нішевої аромакосметики для волосся, створений
                для тих, хто не йде на компроміс із якістю. Кожен продукт — це результат глибоких
                досліджень та турботи про здоров&apos;я та красу волосся.
              </p>
              <Link
                href='/shop'
          ...
          <div className='grid grid-cols-1 lg:grid-cols-2 gap-12 items-center'>
            ...
            <div>
              ...
              <p className='text-[#6B6B6B] mb-8 leading-relaxed'>
                Салон Viola у Мукачево, Закарпатська область — простір, де кожен
                клієнт отримує увагу, професійність та турботу. У нас Ви можете
                придбати косметику Na Golov[y] та отримати консультацію
                безпосередньо від експерта бренду.
              </p>
              <Link
                href='/contacts'
