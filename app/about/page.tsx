          ...
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 items-center">
            ...
            <div>
              ...
              <p className="text-[#6B6B6B] mb-4 leading-relaxed">
                Як експерт бренду Na Golov[y], засновниця салону краси &quot;Viola&quot;, з досвідом понад 30 років,
                я поєдную глибокі знання про догляд за волоссям з пристрастю до справжньої якості.
              </p>
              <p className="text-[#6B6B6B] mb-4 leading-relaxed">
                Мій підхід — персональна консультація та підбір догляду індивідуально. Кожна робота починається
                з діагностики волосся та шкіри голови, після чого ми підбираємо систему яка підходить саме Вам!
              </p>
              <p className="text-[#6B6B6B] mb-8 leading-relaxed">
                Салон Viola — простір, де кожен клієнт отримує увагу, професійність та турботу. У нас Ви можете
                придбати косметику Na Golov[y] та отримати консультацію безпосередньо від експерту бренду.
              </p>
              <Link
                href="/contacts"
