      ...
      <div className="prose prose-sm max-w-none text-[#4A4A4A] space-y-6">
        ...
        <section>
          ...
          <ul className="list-disc list-inside space-y-1 ml-2">
            ...
            <li>LiqPay — для обробки платіжних операцій</li>
            <li>Resend — для надсилання листів-підтверджень замовлення</li>
            <li>Telegram — для внутрішнього сповіщення про нове замовлення</li>
          </ul>
          <p>
