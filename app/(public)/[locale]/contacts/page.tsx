...
export async function generateMetadata({
  ...
  const ukUrl = `${siteUrl}/contacts`;
  const enUrl = `${siteUrl}/en/contacts`;
      ...
      <div className="max-w-6xl mx-auto px-4 sm:px-6 lg:px-8 py-12">
        ...
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 lg:gap-16">
          ...
          <div className="space-y-8">
            ...
            <div>
              <p className="text-[#C4A882] text-xs uppercase tracking-[0.25em] mb-1">{t("phone")}</p>
              <TrackedLink
                href="tel:+380500582175"
                eventName="click_phone"
                eventParams={{ location: "contacts" }}
            ...
            <div>
              <p className="text-[#C4A882] text-xs uppercase tracking-[0.25em] mb-1">{t("address")}</p>
              <p className="text-[#1A1A1A] font-medium">{t("salonName")}</p>
              <p className="text-[#6B6B6B]">{t("salonAddress")}</p>
            </div>

            <div>
              <p className="text-[#C4A882] text-xs uppercase tracking-[0.25em] mb-3">{t("socialMedia")}</p>
              <div className="flex flex-col gap-2">
                <TrackedLink
                  ...
                  eventParams={{ network: "instagram", location: "contacts" }}
                ...
                <TrackedLink
                  ...
                  rel="noopener noreferrer"
                  eventName="click_social"
                  eventParams={{ network: "telegram", location: "contacts" }}
                  className="flex items-center gap-2 text-[#1A1A1A] hover:text-[#C4A882] transition-colors text-sm"
                >
                  <svg className="w-4 h-4" fill="currentColor" viewBox="0 0 24 24">
            ...
            <div>
              <p className="text-[#C4A882] text-xs uppercase tracking-[0.25em] mb-1">{t("workingHours")}</p>
              <p className="text-[#6B6B6B] text-sm">{t("weekdays")}</p>
              <p className="text-[#6B6B6B] text-sm">{t("sunday")}</p>
            </div>
          </div>
