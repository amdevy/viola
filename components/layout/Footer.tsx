      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-12">
        <div className="grid grid-cols-1 md:grid-cols-4 gap-8">
          ...
          <div className="md:col-span-1">
            ...
            <div className="flex gap-3">
              ...
              <span
                className="w-8 h-8 bg-white/10 rounded flex items-center justify-center cursor-default opacity-60"
                aria-label="Telegram"
              >
                <svg className="w-4 h-4" fill="currentColor" viewBox="0 0 24 24">
          ...
          {/* Shop */}
          <div>
            <h4 className="text-sm font-semibold uppercase tracking-widest text-white mb-4">Магазин</h4>
            <ul className="space-y-2">
              {[
                ...
                <li key={l.href}>
                  <Link href={l.href} className="text-sm text-[#A0A0A0] hover:text-[#C4A882] transition-colors">
                    {l.label}
                  </Link>
                </li>
              ))}
          ...
          {/* Info */}
          <div>
            <h4 className="text-sm font-semibold uppercase tracking-widest text-white mb-4">Інформація</h4>
            <ul className="space-y-2">
              {[
          ...
          {/* Contact */}
          <div>
            <h4 className="text-sm font-semibold uppercase tracking-widest text-white mb-4">Контакти</h4>
            <ul className="space-y-2 text-sm text-[#A0A0A0]">
              <li>
                <a href="tel:+380501234567" className="hover:text-[#C4A882] transition-colors">
                  +38 050 123 45 67
                </a>
              </li>
              <li>
                <a href="mailto:hello@viola.com.ua" className="hover:text-[#C4A882] transition-colors">
                  hello@viola.com.ua
                </a>
              </li>
              <li className="mt-4">
        ...
        <div className="border-t border-white/10 mt-10 pt-6 flex flex-col sm:flex-row items-center justify-between gap-2">
          ...
          <div className="flex gap-4">
            <Link href="/privacy" className="text-xs text-[#6B6B6B] hover:text-[#C4A882] transition-colors">
              Політика конфіденційності
            </Link>
            <Link href="/terms" className="text-xs text-[#6B6B6B] hover:text-[#C4A882] transition-colors">
              Умови використання
            </Link>
          </div>
        </div>
